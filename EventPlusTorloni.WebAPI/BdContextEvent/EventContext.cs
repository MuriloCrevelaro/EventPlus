...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.IdComentarioEvento).HasName("PK__Comentar__C6560AEBDB2DDBAB");
        ...
        {
            entity.HasKey(e => e.IdEvento).HasName("PK__Evento__C8DC7BDAB246208A");
        ...
        {
            entity.HasKey(e => e.IdInstituição).HasName("PK__Institui__11B8026904E1DB6A");
        ...
        {
            entity.HasKey(e => e.IdPresenca).HasName("PK__Presenca__44CEA427BDF54E22");
        ...
        {
            entity.HasKey(e => e.IdTipoEvento).HasName("PK__TipoEven__09EED93A71317509");
        ...
        {
            entity.HasKey(e => e.IdTipoUsuario).HasName("PK__TipoUsua__03006BFF4DC528B2");
        ...
        {
            entity.HasKey(e => e.IdUsuario).HasName("PK__Usuario__645723A68D414CC4");

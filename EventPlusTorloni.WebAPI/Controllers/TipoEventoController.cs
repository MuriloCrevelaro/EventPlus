...
public class TipoEventoController : ControllerBase
{
    ...
    /// <summary>
    /// Endpoint da API que faz chamada para o método listar os tipos de evento
    /// </summary>
    ...
    /// <summary>
    /// Endpoint da API que faz chamada para o método de buscar por id do tipo de evento especifico
    /// </summary>
    /// <param name="id">id do tipo de evento buscado</param>
    /// <returns>Status code 200 e o tipo de evento buscador</returns>
    [HttpGet("{id}")]
    ...
    /// <summary>
    /// Endpoint da API que faz chamada para o método de cadastrar um novo tipo de evento
    /// </summary>
    /// <param name="tipoEvento">Tipo de evento a ser cadastrado</param>
    /// <returns>Status code 201 e o tipo evento cadastrado</returns>
    [HttpPost]
    ...
    /// <summary>
    /// Endpoint da API que faz chamada para o método de atualizar um tipo de evento
    /// </summary>
    ...
    /// <summary>
    /// Endpoint de API que faz chamada para o método de deletar um tipo de evento
    /// </summary>
